...
class MediaMessage
{
    ...
    private $query;
    /**
     * @var ContextMediaMessage
     */
    private $context;


    public function __construct(string $action, string $media = '', string $query = '', ContextMediaMessage $context = null)
    {
        $this->media = $media;
        $this->action = $action;
        $this->query = $query;
    ...
    /**
     * @return ContextMediaMessage
     */
    public function getContext(): ContextMediaMessage
    {
        return $this->context;
    }
